...
public class ElementDetector extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        // if something is wrong, we assume there's top
        if (mat.empty()) {
            location = ElementLocation.TOP;
            return input;
        }
        ...
        if (!left) location = ElementLocation.LEFT;
        else if (!right) location = SkystoneLocation.MIDDLE;
        ...
        else location = SkystoneLocation.RIGHT;
